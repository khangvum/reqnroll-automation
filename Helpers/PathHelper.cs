...
namespace ReqnrollAutomation.Helpers
{
    ...
    internal static class PathHelper
    {
        ...
        private static readonly string _baseDirectory = Path.Combine(
            Directory.GetParent(AppContext.BaseDirectory)?.Parent?.Parent?.Parent?.FullName ?? throw new DirectoryNotFoundException("Could not determine project root directory."),
            "TestResults",
            _timestamp);
        #endregion
